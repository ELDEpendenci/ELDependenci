...
public class BungeeServiceCollection extends ELDServiceCollection<BungeeCommand, Listener, Plugin> {
    ...
    @Override
    public Map.Entry<Class<? extends CommonRegistry<BungeeCommand, Listener>>, Class<? extends LifeCycle<Plugin>>> getComponents(MCPlugin plugin) {
