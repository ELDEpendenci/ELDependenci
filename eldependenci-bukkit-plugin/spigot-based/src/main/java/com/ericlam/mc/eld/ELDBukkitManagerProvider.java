...
public class ELDBukkitManagerProvider extends CommonManagerProvider<CommandSender, BukkitCommand, Listener, JavaPlugin> implements BukkitManagerProvider {

    private final ItemInteractManager itemInteractManager;

    public ELDBukkitManagerProvider(
            ELDServiceCollection<BukkitCommand, Listener, JavaPlugin> serviceCollection,
